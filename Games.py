...
class XO:  # done for offline gaming
    ...
    def __isEndOfGame(self) -> bool:
        if any(len(set(row)) == 1 and set(row) != {' '} for row in self.__field) or\
            any(len(set([row[i] for row in self.__field])) == 1 and set([row[i] for row in self.__field]) != {' '} for i in range(3)) or\
                len(set([self.__field[i][j] for i in range(3) for j in range(3) if i + j == 2])) == 1 and set([self.__field[i][j] for i in range(3) for j in range(3) if i + j == 2]) != {' '} or\
                    len(set([self.__field[i][j] for i in range(3) for j in range(3) if i == j])) == 1 and set([self.__field[i][j] for i in range(3) for j in range(3) if i == j]) != {' '}:
            return True
        return False
...
class SeaBattle:
                                            ...
                                            left_coord == 10 and\
                                                not '#' in [
                                                    ...
                                                    field[1][9]
                                                        ...
                                                        left_coord in [_ for _ in range(2, 10)] and\
                                                            not '#' in [
                                                                field[0][left_coord    ],
                                        ...
                                        if good_position:
                                            if left_coord == 1:
                                                for row in range(top_coord - 1,  top_coord + ship_length):
                                                    if (row == 0 and field[row][1] == '#') or (row == 9 and field[row][1] == '#') or\
                                                    (row in [val for val in range(1, 9)] and (field[row][1] == '#' or field[row + 1][0] == '#')) or\
                                                    field[row + 1][left_coord - 1] == '#' or\
                                                    field[row - 1][left_coord - 1] == '#':
                                                        good_position = False
                                                        break
                                            elif left_coord == 10:
                                                for row in range(top_coord - 1,  top_coord + ship_length):
                                                    if (row == 0 and field[row][8] == '#') or (row == 9 and field[row][8] == '#') or\
                                                    (row in [val for val in range(1, 9)] and (field[row][8] == '#' or field[row + 1][9] == '#')) or\
                                                    field[row + 1][left_coord - 1] == '#' or\
                                                    field[row - 1][left_coord - 1] == '#':
                                                        good_position = False
                                                        break
                                                ...
                                                for row in range(top_coord - 1,  top_coord + ship_length):
                                                    if (row == 0 and ('#' in [field[row][left_coord - 2], field[row][left_coord]])) or\
                                                    (row == 9 and ('#' in [field[row][left_coord - 2], field[row][left_coord]])) or\
                                                    (row in [val for val in range(1, 9)] and ('#' in \
                                                    [
                                                    ...
                                                    field[row + 1][left_coord]
                                                        ...
                                                        (row == top_coord - 1 and row > 0 and '#' in [\
                                                        field[row - 1][left_coord - 2],
                                                        field[row - 1][left_coord - 1],
                                                        field[row - 1][left_coord]
                                                        ]\
                                        ...
                                        if good_position:
                                            if top_coord == 1:
                                                for col in range(left_coord - 1,  left_coord + ship_length):
                                                    if (col == 0 and field[1][0] == '#') or (col == 9 and field[1][9] == '#') or\
                                                    (col in [val for val in range(1, 9)] and (field[1][col] == '#' or field[0][col + 1] == '#')):
                                                        good_position = False
                                                        break
                                                ...
                                                if field[top_coord - 1][left_coord - 2] == '#':
                                                    ...
                                                    for col in range(left_coord - 1,  left_coord + ship_length):
                                                        if (col == 0 and field[8][0] == '#') or (col == 9 and field[8][9] == '#') or\
                                                        (col in [val for val in range(1, 9)] and (field[8][col] == '#' or field[9][col + 1]== '#')):
                                                            good_position = False
                                                            break
                                            else:
                                                for col in range(left_coord - 1,  left_coord + ship_length):
                                                    if col == 0 and ('#' in [field[top_coord - 1][top_coord - 2], field[top_coord - 1][top_coord]]) or\
                                                    (col == 9 and ('#' in [field[top_coord - 1][top_coord - 2], field[top_coord - 1][top_coord]])) or\
                                                    (col in [val for val in range(1, 9)] and ('#' in \
                                                    [
                                                    ...
                                                    field[top_coord    ][col + 1],
                                                        ...
                                                        (col == left_coord - 1 and col > 0 and '#' in [\
                                                        field[top_coord - 2][col - 1],
                                                        field[top_coord - 1][col - 1],
                                                        field[top_coord    ][col - 1],
                                                        ]):
    ...
    def __render(self) -> None:
        ...
        for i in range(9):
            ...
            print(line)
        print('10| ' + str([point for point in self.field1[9]])[2:-2].replace('\', \'', ' ') +\
            '       10| ' + str([point for point in self.field2[9]])[2:-2].replace('\', \'', ' '))
        print('------------------------      ------------------------\n')
                    ...
                    if line == 0:
                        if column == 0:
                            ...
                            for col in range(column, column + length):
                                field[1][col] = '~'
                            field[1][col + length - 2], field[0][col + length - 2] = '~', '~'
                    elif line == 9:
                        if column == 0:
                            field[8][0], field[8][1], field[9][1] = '~', '~', '~'
                        elif column == 9:
...
# horizontal: deleting left part when exploding
# vertical:   exploding where damaged bottom or under top of a ship
# vartical/horizontal: 
